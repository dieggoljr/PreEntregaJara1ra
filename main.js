alert("Bienvenido a Nuestro Hotel!!");

let nombre = prompt("¿Cómo te llamas?");
    alert("Gracias por tu preferencia " + nombre);

let cantPersonas;

do {
  cantPersonas = parseInt(
    prompt(`${nombre}, ¿Cuántas personas se van a hospedar?`)
  );
  if (isNaN(cantPersonas)) {
    alert(`$ Ahora ingresá un número de personas que se van a hospedar.`);
  }
} while (isNaN(cantPersonas));

alert("Se van a hospedar:", cantPersonas, "personas");
...
alert("Usted seleccionó", cantDias, "días para su estadía.");
